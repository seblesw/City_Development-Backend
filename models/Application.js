    ...
    "Application",
    {
      ...
      application_code: {
        ...
        validate: {
          ...
          len: { args: [5, 20], msg: "የመጠየቂያ ኮድ ከ5 እስከ 20 ቁምፊዎች መሆን አለበት።" },
        },
      },
      user_id: {
        type: DataTypes.INTEGER,
    ...
    },
    {
      ...
      hooks: {
        beforeCreate: async (application, options) => {
          ...
          const landOwner = await db.models.LandOwner.findByPk(
            application.user_id,
            {
              transaction: options.transaction,
            }
        ...
        beforeUpdate: async (application, options) => {
          ...
          if (application.changed("status")) {
            ...
            if (
              ...
              throw new Error(
                `ከ${previousStatus} ወደ ${application.status} መሸጋገር አይፈቀድም።`
              );
            }
        ...
        beforeValidate: async (application, options) => {
          ...
          if (landOwner.marital_status === "ባለትዳር" && coOwnersCount !== 1) {
            ...
            landOwner.marital_status === "ጋራ ባለቤትነት" &&
            coOwnersCount < 1
          ) {
